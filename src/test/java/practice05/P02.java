...
public class P02 extends TestBase {
    ...
    public void test01() {
        ...
        driver.switchTo().frame(iframe);//iframe gecti
        ...
        driver.switchTo().defaultContent();//iframeden cıktık
        //Assert.assertTrue(driver.findElement(By.xpath("//*[.='Elemental Selenium']")).isSelected());--- bu sekılde de olur
        ...
        System.out.println("Acilan pencerelerin handle degerleri :"+windowHandle);
        ...
        System.out.println("Elemental selenıun sayfa basllıgı :"+driver.getTitle());
