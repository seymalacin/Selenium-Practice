    ...
    public void test01() throws InterruptedException {
              ...
              // - yeni sekmede amazon adresine gidiniz
               ...
               // - ilk sekmeye geri dönüp url'ini konsola yazdıralım
                   driver.switchTo().window(ilkWindow);//https://html.com/tags/iframe/ adresıne donduk
                   System.out.println("İlk window url'i :"+driver.getCurrentUrl());

              // - ilk sekmeyi kapatalım
                   driver.close();
              // - Sonra diğer sekmeyide kapatalım
                //- TestBasedeki @After notasyonu calisacak

                 //Amazon sayfasını kapatalım - burayı kapatmak ıstersek
