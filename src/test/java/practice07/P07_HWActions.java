...
public class P07_HWActions extends TestBase {
    ...
    public void test1() throws InterruptedException {
       ...
       // actions.moveToElement(kutu).perform();
        ...
        WebElement yazı = driver.findElement(By.xpath("//*[.='Please select an item from left to start practice.']"));
        ...
        Assert.assertTrue(driver.findElement(By.xpath("//h")).isDisplayed());
